<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
            ...
            <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="{{url('/dashboard/fidelity')}}">E-Shop Web</a>            
            ...
            <ul class="navbar-nav align-items-center ms-auto">                
                ...
                <button class="btn btn-link dropdown-toggle" style="color: grey;" type="button" data-bs-toggle="dropdown" aria-expanded="false">{{session('user_name')}}</button>
                    ...
                    <div class="dropdown-divider"></div>
                        ...
                        <a class="dropdown-item" href="{{url('/fidelity/'.$card->user_id)}}">
                            <div class="dropdown-item-icon"><i data-feather="shopping-cart"></i></div>
                            {{$card->user_name}}
                        </a>
                        @endforeach                        
                    </div>
