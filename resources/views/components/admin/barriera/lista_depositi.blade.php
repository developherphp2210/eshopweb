                                ...
                                <div class="card-body">                                
                                    ...
                                    <div class="row">                                    
                                        <div class="col-4">
                                            ...
                                            <input class="form-control" type="text" maxlength="6" readonly id="codice" name="codice" value="{{$listadepositi['deposito'][0]->codice}}">
                                        </div>                                        
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-8">
                                            <h5 class="mb-1">Descrizione</h5>
                                            <input class="form-control" type="text" maxlength="25" readonly name="descrizione" id="descrizione" value="{{$listadepositi['deposito'][0]->descrizione}}">
                                        </div>
                                        <div class="col-4">
                                            <h5 class="mb-1">Listino Associato</h5>
                                            <select class="form-select mb-3"  name="id_listino" id="id_listino">
                                    ...
                                    <div class="row mt-4 p-3">
                                        <div class="col-12">
                                            <h5 class="mb-1">Intestazione Scontrino</h5>
                                            <input type="text" class="form-control text-center" id="riga1" name="riga1" value="{{$listadepositi['deposito'][0]->riga1}}">
                                            <input type="text" class="form-control text-center" id="riga2" name="riga2" value="{{$listadepositi['deposito'][0]->riga2}}">
                                            <input type="text" class="form-control text-center" id="riga3" name="riga3" value="{{$listadepositi['deposito'][0]->riga3}}">
                                            <input type="text" class="form-control text-center" id="riga4" name="riga4" value="{{$listadepositi['deposito'][0]->riga4}}">
                                            <input type="text" class="form-control text-center" id="riga5" name="riga5" value="{{$listadepositi['deposito'][0]->riga5}}">
                                            <input type="text" class="form-control text-center" id="riga6" name="riga6" value="{{$listadepositi['deposito'][0]->riga6}}">
                                        </div>
                                    </div>
                                </div>                                
