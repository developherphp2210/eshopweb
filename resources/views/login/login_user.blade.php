                                        ...
                                        <form action="{{url('dologin')}}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div id="passwordHelpBlock" class="form-text">
                                                    La tua password deve essere lunga 8-20 caratteri, deve contenere lettere e numeri e non deve contenere spazi, caratteri speciali o emoji.
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="">Recupera Password</a>
